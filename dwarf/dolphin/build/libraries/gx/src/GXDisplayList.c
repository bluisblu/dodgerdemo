/*
    Compile unit: c:\dolphin\build\libraries\gx\src\GXDisplayList.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x80025EFC -> 0x80025F6C
*/
// total size: 0x24
struct __GXFifoObj {
    // Members
...
// Range: 0x80025EFC -> 0x80025F6C
void GXCallDisplayList(void * list /* r30 */, unsigned long nbytes /* r31 */) {
    // References
