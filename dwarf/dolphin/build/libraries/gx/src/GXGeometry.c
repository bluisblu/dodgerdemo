/*
    Compile unit: c:\dolphin\build\libraries\gx\src\GXGeometry.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x800227BC -> 0x80022B74
*/
// total size: 0x10
struct _GXTexRegion {
    // Members
...
// Range: 0x80022848 -> 0x80022924
void GXBegin(enum _GXPrimitive type /* r29 */, enum _GXVtxFmt vtxfmt /* r30 */, unsigned short nverts /* r31 */) {
    // References
    // -> struct __GXData_struct * gx;
}

// Range: 0x80022924 -> 0x800229AC
void __GXSendFlushPrim() {
    // Local variables
    unsigned long i; // r1+0x0
    unsigned long numD; // r7
...
// Range: 0x800229AC -> 0x80022A04
void GXSetLineWidth(unsigned char width /* r1+0x0 */, enum _GXTexOffset texOffsets /* r1+0x4 */) {
    // References
    // -> struct __GXData_struct * gx;
}

// Range: 0x80022A04 -> 0x80022A58
void GXSetPointSize(unsigned char pointSize /* r1+0x0 */, enum _GXTexOffset texOffsets /* r1+0x4 */) {
    // References
    // -> struct __GXData_struct * gx;
}
...
// Range: 0x80022A58 -> 0x80022ABC
void GXEnableTexOffsets(enum _GXTexCoordID coord /* r1+0x0 */, unsigned char line_enable /* r1+0x4 */, unsigned char point_enable /* r1+0x5 */) {
    // References
    // -> struct __GXData_struct * gx;
}
...
// Range: 0x80022ABC -> 0x80022B0C
void GXSetCullMode(enum _GXCullMode mode /* r3 */) {
    // Local variables
    enum _GXCullMode hwMode; // r3

    // References
    // -> struct __GXData_struct * gx;
}

// Range: 0x80022B0C -> 0x80022B50
void GXSetCoPlanar(unsigned char enable /* r1+0x0 */) {
    // References
    // -> struct __GXData_struct * gx;
}

// Range: 0x80022B50 -> 0x80022B74
void __GXSetGenMode() {
    // References
    // -> struct __GXData_struct * gx;
}
