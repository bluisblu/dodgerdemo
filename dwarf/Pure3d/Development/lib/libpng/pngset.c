/*
    Compile unit: D:\Pure3d\development\lib\libpng\pngset.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80090F24 -> 0x80091680
*/
// total size: 0xC
...
// Range: 0x80090F24 -> 0x80090F7C
void png_set_bKGD(struct png_struct_def * png_ptr /* r1+0x8 */, struct png_info_struct * info_ptr /* r31 */, struct png_color_16_struct * background /* r5 */) {}

// Range: 0x80090F7C -> 0x80090FE0
void png_set_cHRM(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, double white_x /* r1+0x8 */, double white_y /* r1+0x10 */, double red_x /* r1+0x18 */, double red_y /* r1+0x20 */, double green_x /* r1+0x28 */, double green_y /* r1+0x30 */, double blue_x /* r1+0x38 */, double blue_y /* r1+0x40 */) {}

// Range: 0x80090FE0 -> 0x8009100C
void png_set_gAMA(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, double file_gamma /* r1+0x8 */) {}

// Range: 0x8009100C -> 0x80091034
void png_set_hIST(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, unsigned short * hist /* r1+0x8 */) {}

// Range: 0x80091034 -> 0x80091138
void png_set_IHDR(struct png_struct_def * png_ptr /* r3 */, struct png_info_struct * info_ptr /* r31 */, unsigned long width /* r1+0x10 */, unsigned long height /* r1+0x14 */, int bit_depth /* r1+0x18 */, int color_type /* r1+0x1C */, int interlace_type /* r1+0x20 */, int compression_type /* r1+0x24 */, int filter_type /* r1+0x40 */) {}

// Range: 0x80091138 -> 0x80091168
void png_set_oFFs(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, unsigned long offset_x /* r1+0x8 */, unsigned long offset_y /* r1+0xC */, int unit_type /* r1+0x10 */) {}

// Range: 0x80091168 -> 0x800912B0
void png_set_pCAL(struct png_struct_def * png_ptr /* r30 */, struct png_info_struct * info_ptr /* r31 */, char * purpose /* r22 */, long X0 /* r23 */, long X1 /* r24 */, int type /* r28 */, int nparams /* r25 */, char * units /* r26 */, char * * params /* r29 */) {
    // Local variables
    unsigned long length; // r27
    int i; // r26
}

// Range: 0x800912B0 -> 0x800912E0
void png_set_pHYs(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, unsigned long res_x /* r1+0x8 */, unsigned long res_y /* r1+0xC */, int unit_type /* r1+0x10 */) {}

// Range: 0x800912E0 -> 0x8009130C
void png_set_PLTE(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, struct png_color_struct * palette /* r1+0x8 */, int num_palette /* r1+0xC */) {}

// Range: 0x8009130C -> 0x80091364
void png_set_sBIT(struct png_struct_def * png_ptr /* r1+0x8 */, struct png_info_struct * info_ptr /* r31 */, struct png_color_8_struct * sig_bit /* r5 */) {}

// Range: 0x80091364 -> 0x80091440
void png_set_sRGB_gAMA_and_cHRM(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, int intent /* r1+0x8 */) {}

// Range: 0x80091440 -> 0x800915A0
void png_set_text(struct png_struct_def * png_ptr /* r26 */, struct png_info_struct * info_ptr /* r28 */, struct png_text_struct * text_ptr /* r27 */, int num_text /* r29 */) {
    // Local variables
    int i; // r30
    struct png_text_struct * old_text; // r31
    int old_max; // r1+0x8
    struct png_text_struct * textp; // r27
}

// Range: 0x800915A0 -> 0x800915F8
void png_set_tIME(struct png_struct_def * png_ptr /* r1+0x8 */, struct png_info_struct * info_ptr /* r31 */, struct png_time_struct * mod_time /* r5 */) {}

// Range: 0x800915F8 -> 0x80091680
void png_set_tRNS(struct png_struct_def * png_ptr /* r1+0x8 */, struct png_info_struct * info_ptr /* r30 */, unsigned char * trans /* r1+0x10 */, int num_trans /* r31 */, struct png_color_16_struct * trans_values /* r7 */) {}
