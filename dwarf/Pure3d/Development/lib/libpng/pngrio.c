/*
    Compile unit: D:\Pure3d\development\lib\libpng\pngrio.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80084FD8 -> 0x800850F8
*/
// total size: 0xC
...
// Range: 0x80084FD8 -> 0x80085018
void png_read_data(struct png_struct_def * png_ptr /* r3 */, unsigned char * data /* r4 */, unsigned long length /* r5 */) {}

// Range: 0x80085018 -> 0x80085074
static void png_default_read_data(struct png_struct_def * png_ptr /* r30 */, unsigned char * data /* r4 */, unsigned long length /* r31 */) {
    // Local variables
    unsigned long check; // r1+0x8
}

// Range: 0x80085074 -> 0x800850F8
void png_set_read_fn(struct png_struct_def * png_ptr /* r31 */, void * io_ptr /* r1+0xC */, void (* read_data_fn)(struct png_struct_def *, unsigned char *, unsigned long) /* r1+0x10 */) {}
