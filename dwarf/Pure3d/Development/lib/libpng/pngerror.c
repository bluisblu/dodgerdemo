/*
    Compile unit: D:\Pure3d\development\lib\libpng\pngerror.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008377C -> 0x80083B3C
*/
// total size: 0xC
...
// Range: 0x8008377C -> 0x800837D8
void png_error(struct png_struct_def * png_ptr /* r30 */, const char * message /* r31 */) {}

// Range: 0x800837D8 -> 0x80083810
void png_warning(struct png_struct_def * png_ptr /* r3 */, const char * message /* r4 */) {}

static char png_digit[16]; // size: 0x10, address: 0x800F97F0
// Range: 0x80083810 -> 0x800839D0
static void png_format_buffer(struct png_struct_def * png_ptr /* r1+0x8 */, char * buffer /* r31 */, const char * message /* r5 */) {
    // Local variables
    int iout; // r30
    int iin; // r8
    int c; // r9
    ...
    // References
    // -> static char png_digit[16];
}

// Range: 0x800839D0 -> 0x80083A2C
void png_chunk_error(struct png_struct_def * png_ptr /* r31 */, const char * message /* r4 */) {
    // Local variables
    char msg[80]; // r1+0x10
}

// Range: 0x80083A2C -> 0x80083A8C
void png_chunk_warning(struct png_struct_def * png_ptr /* r31 */, const char * message /* r4 */) {
    // Local variables
    char msg[80]; // r1+0x10
}
...
// Range: 0x80083A8C -> 0x80083AE0
static void png_default_error(struct png_struct_def * png_ptr /* r31 */, const char * message /* r5 */) {
    // References
    // -> struct _FILE __files[];
}

// Range: 0x80083AE0 -> 0x80083B2C
static void png_default_warning(struct png_struct_def * png_ptr /* r31 */, const char * message /* r5 */) {
    // References
    // -> struct _FILE __files[];
}

// Range: 0x80083B2C -> 0x80083B3C
void png_set_error_fn(struct png_struct_def * png_ptr /* r1+0x0 */, void * error_ptr /* r1+0x4 */, void (* error_fn)(struct png_struct_def *, char *) /* r1+0x8 */, void (* warning_fn)(struct png_struct_def *, char *) /* r1+0xC */) {}
