/*
    Compile unit: D:\Pure3d\development\lib\libpng\pngmem.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80083CF4 -> 0x80084004
*/
// Range: 0x80083CF4 -> 0x80083DA8
void * png_create_struct_2(int type /* r1+0x8 */, void * (* malloc_fn)(struct png_struct_def *, unsigned long) /* r4 */) {
    // Local variables
    unsigned long size; // r30
    void * struct_ptr; // r31
}

// Range: 0x80083DA8 -> 0x80083DCC
void png_destroy_struct(void * struct_ptr /* r3 */) {}
...
// Range: 0x80083DCC -> 0x80083E18
void png_destroy_struct_2(void * struct_ptr /* r1+0x8 */, void (* free_fn)(struct png_struct_def *, struct png_struct_def *) /* r4 */) {
    // Local variables
    struct png_struct_def dummy_struct; // r1+0x10
    struct png_struct_def * png_ptr; // r3
}

// Range: 0x80083E18 -> 0x80083E68
void * png_malloc(struct png_struct_def * png_ptr /* r3 */, unsigned long size /* r4 */) {}

// Range: 0x80083E68 -> 0x80083EBC
void * png_malloc_default(struct png_struct_def * png_ptr /* r30 */, unsigned long size /* r4 */) {
    // Local variables
    void * ret; // r31
}

// Range: 0x80083EBC -> 0x80083F08
void png_free(struct png_struct_def * png_ptr /* r3 */, void * ptr /* r4 */) {}

// Range: 0x80083F08 -> 0x80083F2C
void png_free_default(void * ptr /* r4 */) {}

// Range: 0x80083F2C -> 0x80083F90
void * png_memcpy_check(struct png_struct_def * png_ptr /* r3 */, void * s1 /* r29 */, void * s2 /* r30 */, unsigned long length /* r6 */) {
    // Local variables
    unsigned long size; // r31
}

// Range: 0x80083F90 -> 0x80083FF4
void * png_memset_check(struct png_struct_def * png_ptr /* r3 */, void * s1 /* r29 */, int value /* r30 */, unsigned long length /* r6 */) {
    // Local variables
    unsigned long size; // r31
}

// Range: 0x80083FF4 -> 0x80084004
void png_set_mem_fn(struct png_struct_def * png_ptr /* r1+0x0 */, void * mem_ptr /* r1+0x4 */, void * (* malloc_fn)(struct png_struct_def *, unsigned long) /* r1+0x8 */, void (* free_fn)(struct png_struct_def *, struct png_struct_def *) /* r1+0xC */) {}
