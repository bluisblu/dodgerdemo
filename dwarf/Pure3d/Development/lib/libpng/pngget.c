/*
    Compile unit: D:\Pure3d\development\lib\libpng\pngget.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80083B3C -> 0x80083CF4
*/
// total size: 0xC
...
// Range: 0x80083B3C -> 0x80083B60
unsigned long png_get_valid(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, unsigned long flag /* r1+0x8 */) {}

// Range: 0x80083B60 -> 0x80083B80
unsigned long png_get_rowbytes(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083B80 -> 0x80083BA0
unsigned long png_get_image_width(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083BA0 -> 0x80083BC0
unsigned long png_get_image_height(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083BC0 -> 0x80083BE0
unsigned char png_get_bit_depth(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083BE0 -> 0x80083C00
unsigned char png_get_color_type(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083C00 -> 0x80083C20
unsigned char png_get_interlace_type(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */) {}

// Range: 0x80083C20 -> 0x80083C64
unsigned long png_get_PLTE(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, struct png_color_struct * * palette /* r1+0x8 */, int * num_palette /* r1+0xC */) {}

// Range: 0x80083C64 -> 0x80083CF4
unsigned long png_get_tRNS(struct png_struct_def * png_ptr /* r1+0x0 */, struct png_info_struct * info_ptr /* r1+0x4 */, unsigned char * * trans /* r1+0x8 */, int * num_trans /* r1+0xC */, struct png_color_16_struct * * trans_values /* r1+0x10 */) {
    // Local variables
    unsigned long retval; // r3
}
