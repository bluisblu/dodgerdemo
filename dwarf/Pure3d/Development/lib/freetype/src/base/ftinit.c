/*
    Compile unit: D:\Pure3d\development\lib\freetype\src\base\ftinit.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x8009958C -> 0x80099614
*/
// total size: 0x10
...
static struct FT_DriverInterface_ * ft_default_drivers[5]; // size: 0x14, address: 0x8010C748
// Range: 0x8009958C -> 0x80099614
int FT_Init_FreeType(struct FT_LibraryRec_ * * library /* r30 */) {
    // Local variables
    int error; // r29
    struct FT_MemoryRec_ * memory; // r3

    // References
    // -> static struct FT_DriverInterface_ * ft_default_drivers[5];
}
