/*
    Compile unit: D:\Pure3d\development\lib\freetype\src\psnames\psnames.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x8009BC70 -> 0x8009BC70
*/
static char * standard_glyph_names[1067]; // size: 0x10AC, address: 0x8010E9C4
static const char * * t1_standard_glyphs; // size: 0x4, address: 0x80139F04
static unsigned short mac_standard_names[259]; // size: 0x206, address: 0x800F9EE0
static unsigned short names_to_unicode[392]; // size: 0x310, address: 0x800FA0E8
static unsigned short t1_standard_encoding[257]; // size: 0x202, address: 0x800FA3F8
static unsigned short t1_expert_encoding[257]; // size: 0x202, address: 0x800FA5FC
// total size: 0x8
struct PS_UniMap_ {
    // Members
...
static struct PSNames_Interface_ psnames_interface; // size: 0x1C, address: 0x800FA800
// total size: 0x8
struct FT_Generic_ {
    // Members
...
struct FT_DriverInterface_ psnames_driver_interface; // size: 0x58, address: 0x800FA81C
