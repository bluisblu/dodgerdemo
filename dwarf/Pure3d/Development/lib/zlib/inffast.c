/*
    Compile unit: D:\Pure3d\development\lib\zlib\inffast.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x80094844 -> 0x80094DE4
*/
...
// Range: 0x80094844 -> 0x80094DE4
int inflate_fast(unsigned int bl /* r1+0x8 */, unsigned int bd /* r1+0xC */, struct inflate_huft_s * tl /* r1+0x10 */, struct inflate_huft_s * td /* r1+0x14 */, struct inflate_blocks_state * s /* r1+0x18 */, struct z_stream_s * z /* r1+0x1C */) {
    // Local variables
    struct inflate_huft_s * t; // r4
    unsigned int e; // r4
    unsigned long b; // r9
    unsigned int k; // r10
    unsigned char * p; // r11
