/*
    Compile unit: D:\Pure3d\development\p3d\platform\gamecube\platform.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800376DC -> 0x80037C04
*/
// total size: 0x18
...
// Range: 0x800376DC -> 0x80037710
// this: r3
tContextInitData::tContextInitData() {}

static class tPlatform * gGlobalPlatform; // size: 0x4, address: 0x8013B228
// total size: 0x8
class tRefCounted {
    // Members
public:
...
class tPlatform {
    ...
    class tContext * CreateContext(class tContextInitData * d);

    void AddTask(class tTask * t);

    void RemoveTask(class tTask * t);
...
// Range: 0x80037710 -> 0x80037760
class tPlatform * tPlatform::Create() {
    // References
    // -> static class tPlatform * gGlobalPlatform;
}

// Range: 0x80037760 -> 0x80037828
// this: r30
tPlatform::tPlatform() {}

// Range: 0x80037828 -> 0x8003790C
// this: r29
class tContext * tPlatform::CreateContext(class tContextInitData * d /* r30 */) {
    // Local variables
    class pddiDevice * device; // r1+0x1C
    class pddiDisplay * display; // r31
    class pddiRenderContext * pddiContext; // r30
}

// Range: 0x8003790C -> 0x80037914
class tPlatform * tPlatform::GetPlatform() {
    // References
    // -> static class tPlatform * gGlobalPlatform;
}
...
// Range: 0x80037914 -> 0x80037980
class tFile * tPlatform::OpenFile(const char * filename /* r31 */) {
    // Local variables
    class tGCFileMap * file; // r3
}

// Range: 0x80037980 -> 0x80037A54
// this: r30
void tPlatform::AddTask(class tTask * t /* r31 */) {
    // Local variables
    int a; // r3
}

// Range: 0x80037A54 -> 0x80037AF0
// this: r30
void tPlatform::RemoveTask(class tTask * t /* r4 */) {
    // Local variables
    int a; // r29
}

// Range: 0x80037AF0 -> 0x80037B2C
// this: r31
void tPlatform::CycleTasks() {}

// Range: 0x80037B2C -> 0x80037C04
void * tPlatform::GCTaskWrapper(void * param /* r3 */) {
    // Local variables
    class tTask * t; // r29
