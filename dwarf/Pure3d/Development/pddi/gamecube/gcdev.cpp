/*
    Compile unit: D:\Pure3d\development\pddi\gamecube\gcdev.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800B4ADC -> 0x800B4E74
*/
// total size: 0x10
class gcDevice : public pddiDevice {
    ...
    class pddiRenderContext * NewRenderContext(class pddiDisplay * display);

    // Members
    unsigned char initialized; // offset 0xC, size 0x1
};
static class gcDevice gblDevice; // size: 0x10, address: 0x8013331C
char libName[9]; // size: 0x9, address: 0x80110A18
// Range: 0x800B4ADC -> 0x800B4B10
int pddiCreate(int versionMajor /* r1+0x0 */, int versionMinor /* r1+0x4 */, class pddiDevice * * device /* r1+0x8 */) {
    // References
    // -> static class gcDevice gblDevice;
}

// total size: 0x34
struct {} pddiDevice::__vtable; // size: 0x34, address: 0x80110B08
// total size: 0x34
struct {} gcDevice::__vtable; // size: 0x34, address: 0x80110AD4
// total size: 0xC
class pddiObject {
    // Members
public:
...
// Range: 0x800B4B10 -> 0x800B4B84
// this: r30
gcDevice::~gcDevice() {
    // References
    // -> struct [anonymous] pddiDevice::__vtable;
    // -> struct [anonymous] gcDevice::__vtable;
}

// Range: 0x800B4B84 -> 0x800B4BA8
void gcDevice::GetLibraryInfo(struct pddiLibInfo * info /* r1+0x4 */) {}

// Range: 0x800B4BA8 -> 0x800B4C2C
class pddiDisplay * gcDevice::NewDisplay() {
    // Local variables
    class gcDisplay * display; // r3
}

// Range: 0x800B4C2C -> 0x800B4CD0
// this: r30
class pddiRenderContext * gcDevice::NewRenderContext(class pddiDisplay * display /* r31 */) {
    // Local variables
    class gcContext * context; // r3
}
...
// Range: 0x800B4CD0 -> 0x800B4D64
class pddiTexture * gcDevice::NewTexture(class pddiRenderContext * context /* r31 */) {
    // Local variables
    class gcTexture * tex; // r3
}

// Range: 0x800B4D64 -> 0x800B4D90
class pddiShader * gcDevice::NewShader(class pddiRenderContext * context /* r4 */, const char * name /* r5 */) {}

static // total size: 0x8
struct {} pddiObject::__RTTI; // size: 0x8, address: 0x8013A048
static // total size: 0x8
struct {} pddiRenderContext::__RTTI; // size: 0x8, address: 0x8013A050
static // total size: 0x8
struct {} pddiBaseContext::__RTTI; // size: 0x8, address: 0x8013A058
static // total size: 0x8
struct {} gcContext::__RTTI; // size: 0x8, address: 0x8013A060
// Range: 0x800B4D90 -> 0x800B4DF8
class pddiPrimBuffer * gcDevice::NewPrimBuffer(class pddiRenderContext * context /* r4 */) {
    // Local variables
    class gcContext * gccon; // r31

    // References
    // -> static struct [anonymous] pddiRenderContext::__RTTI;
    // -> static struct [anonymous] gcContext::__RTTI;
}

// Range: 0x800B4DF8 -> 0x800B4DFC
void gcDevice::AddCustomShader() {}

// Range: 0x800B4DFC -> 0x800B4E00
void gcDevice::Release() {}

static // total size: 0x8
struct {} pddiDevice::__RTTI; // size: 0x8, address: 0x8013A068
static // total size: 0x8
struct {} gcDevice::__RTTI; // size: 0x8, address: 0x8013A070
